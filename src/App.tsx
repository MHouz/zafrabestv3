...
const PRODUCTS = [
  { id: 1, name: "Smoked Paprika", type: "Earth & Fire", category: "spice", price: "8.50", img: `${base}images/spices/Red_paprika_powder_202604261749.jpeg` },
  { id: 2, name: "Wild Turmeric", type: "Roots & Herbs", category: "spice", price: "12.00", img: `${base}images/spices/Turmeric_powder_in_202604261749.jpeg` },
  { id: 3, name: "Royal Saffron", type: "Exotic Blends", category: "spice", price: "24.50", img: `${base}images/spices/Saffron_threads_in_202604261749.jpeg` },
  { id: 4, name: "Ancient Cumin", type: "Daily Essentials", category: "spice", price: "9.00", img: `${base}images/spices/Cumin_seeds_in_202604261749.jpeg` },
  { id: 5, name: "Ceylon Cinnamon", type: "Sweet & Warm", category: "spice", price: "11.00", img: `${base}images/spices/Cinnamon_sticks_in_202604261749.jpeg` },
  { id: 6, name: "Signature Collection", type: "The Classics", category: "pack", price: "45.00", img: `${base}images/packs/Kraft_pouch_labeled_202604261750.jpeg` },
  { id: 7, name: "Marrakech Explorer Set", type: "Traveler's Choice", category: "pack", price: "55.00", img: `${base}images/packs/Zafra_Marrakech_Cinnamon_202604261749.jpeg` },
  { id: 8, name: "Chef's Essentials Pack", type: "Professional Grade", category: "pack", price: "85.00", img: `${base}images/packs/Kraft_paper_pouch_202604261749_1.jpeg` },
  { id: 9, name: "Baker's Joy Set", type: "Sweet Blends", category: "pack", price: "38.00", img: `${base}images/packs/Kraft_paper_pouch_202604261750.jpeg` },
];
        ...
        <>
          ...
          <section className="relative h-[95vh] flex items-center justify-center text-center overflow-hidden">
            <div className="absolute inset-0 bg-zafra-dark">
              <img 
                src={`${base}images/backgrounds/Marrakech_spice_souk_202604261753.jpeg`} 
                alt="Marrakech Souk" 
          ...
          <section className="relative py-40 flex items-center justify-center my-10 min-h-[500px]">
            <div className="absolute inset-0 parallax-banner" style={{backgroundImage: `url('${base}images/backgrounds/Moroccan_spice_market_202604261757.jpeg')`}}>
          ...
          <section className="py-24 bg-white">
            <div className="max-w-7xl mx-auto px-6 text-center">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-12">
                {[
                  { name: "Heat & Chilis", img: `${base}images/spices/Red_paprika_powder_202604261749.jpeg` },
                  { name: "Sweet & Baking", img: `${base}images/spices/Cinnamon_sticks_in_202604261749.jpeg` },
                  { name: "Aromatic Herbs", img: `${base}images/spices/Cumin_seeds_in_202604261749.jpeg` },
                  { name: "Global Blends", img: `${base}images/spices/Turmeric_powder_in_202604261749.jpeg` }
                ].map((cat, idx) => (
        ...
        <section className="pt-32 md:pt-40 pb-24 bg-white min-h-screen">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center mb-32">
              <img src={`${base}images/backgrounds/Spice_bowls_on_202604261755.jpeg`} alt="Tradition" className="rounded-none shadow-2xl" />
              <div>
          ...
          <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="relative">
              <div className="grid grid-cols-2 gap-4">
                <img src={`${base}images/backgrounds/Spices_scattered_on_202604261753.jpeg`} className="rounded-lg shadow-2xl mt-12" alt="Spices" />
                <img src={`${base}images/backgrounds/Moroccan_spice_background_202604261806.jpeg`} className="rounded-lg shadow-2xl" alt="Sacks" />
              </div>
